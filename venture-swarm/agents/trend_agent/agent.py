...
from agents.trend_agent.prompts import SYSTEM_PROMPT
from agents.trend_agent.seeds import SEED_ITEMS
...
install_shutdown_handlers("trend-agent", _stop_runtime)
...
async def lifespan(_: FastAPI):
    ...
    _process_message = build_startup_task_processor(
        ...
        base_notes=["Uses configured LLM provider for live trend reasoning when available."],
    )
