...
Zynd-compatible Directory (/v1/agents, /v1/search)
  ↑                                      ↓
Agents (trend, funding, benchmarking, competitor, startup-compare, market-gap, financial-signals, risk)
...
SERVICE_URL=http://localhost:8108 uvicorn agents.startup_compare_agent.agent:app --port 8108
...
- **No agents discovered**: verify all eight agents are running and registered (`/v1/search` on directory)
...
- **Port conflicts**: check service ports `8000, 8001, 8101-8108`
